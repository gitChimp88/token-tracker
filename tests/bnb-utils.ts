...
import { BNBTransfer, Burn, Freeze, Unfreeze } from "../generated/BNB/BNB"

export function createBNBTransferEvent(
  from: Address,
  to: Address,
  value: BigInt
): BNBTransfer {
  let bnbTransferEvent = changetype<BNBTransfer>(newMockEvent())

  bnbTransferEvent.parameters = new Array()

  bnbTransferEvent.parameters.push(
