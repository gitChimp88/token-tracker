...
export class DaiApproval extends ethereum.Event {
  get params(): DaiApproval__Params {
    return new DaiApproval__Params(this);
  }
}

export class DaiApproval__Params {
  _event: DaiApproval;

  constructor(event: DaiApproval) {
    this._event = event;
  }
...
export class DaiTransfer extends ethereum.Event {
  get params(): DaiTransfer__Params {
    return new DaiTransfer__Params(this);
  }
}

export class DaiTransfer__Params {
  _event: DaiTransfer;

  constructor(event: DaiTransfer) {
    this._event = event;
  }
