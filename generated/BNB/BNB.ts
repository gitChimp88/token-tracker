...
export class BNBTransfer extends ethereum.Event {
  get params(): BNBTransfer__Params {
    return new BNBTransfer__Params(this);
  }
}

export class BNBTransfer__Params {
  _event: BNBTransfer;

  constructor(event: BNBTransfer) {
    this._event = event;
  }
