...
export class BATokenTransfer extends ethereum.Event {
  get params(): BATokenTransfer__Params {
    return new BATokenTransfer__Params(this);
  }
}

export class BATokenTransfer__Params {
  _event: BATokenTransfer;

  constructor(event: BATokenTransfer) {
    this._event = event;
  }
...
export class BATokenApproval extends ethereum.Event {
  get params(): BATokenApproval__Params {
    return new BATokenApproval__Params(this);
  }
}

export class BATokenApproval__Params {
  _event: BATokenApproval;

  constructor(event: BATokenApproval) {
    this._event = event;
  }
...
export class BAToken extends ethereum.SmartContract {
  static bind(address: Address): BAToken {
    return new BAToken("BAToken", address);
  }
